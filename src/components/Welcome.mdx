...
1교시 (8시00분 ~ 8시50분), 2교시 (8시55분 ~ 9시45분), 행사 및 공지 시간 (9시45분~10시),
연습 및 소셜댄스 : 강남 라틴 10시~ (주소: 테헤란로 6길 9),

- 목요일 강남 9-10시 (주소: 추후 공지)에 강습이 진행됩니다.

불편하지 않은 옷과 신발차림으로 와주시면 됩니다. (밑창이 뻑뻑해서 너무 안미끄러지는 신발은 피해주세요!, 마실 음료도 있으면 좋습니다)
...
Please wear comfortable clothes and shoes. (Avoid shoes with very stiff soles that don't slide at all! It's also good to bring something to drink.)
